...
export type InsertBoardMutation = { __typename?: 'mutation_root' } & {
  insert_boards_one?: Maybe<
    { __typename?: 'boards' } & Pick<Boards, 'id' | 'name'>
  >
}
...
export function useBoardSubscription<TData = BoardSubscription>(
  options: Omit<
    Urql.UseSubscriptionArgs<BoardSubscriptionVariables>,
    'query'
  > = {},
  handler?: Urql.SubscriptionHandler<BoardSubscription, TData>,
) {
  return Urql.useSubscription<
    BoardSubscription,
    TData,
    BoardSubscriptionVariables
  >({ query: BoardDocument, ...options }, handler)
}
...
export function useDeleteListMutation() {
  return Urql.useMutation<DeleteListMutation, DeleteListMutationVariables>(
    DeleteListDocument,
  )
}
