...
const Icon = styled.svg(
  tw`w-5 h-5 text-indigo-500 transition duration-150 ease-in-out group-hover:text-indigo-400`,
)

interface ButtoStyledProps {
  className?: string
}

const ButtonStyled: React.FC<ButtoStyledProps> = ({
  className,
  children,
  ...props
}) => (
