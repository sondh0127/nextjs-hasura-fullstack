...
export type BoardsQuery = { __typename?: 'query_root' } & {
  boards: Array<{ __typename?: 'boards' } & BoardFragment>
}
...
export type DeleteBoardMutation = { __typename?: 'mutation_root' } & {
  delete_boards_by_pk?: Maybe<{ __typename?: 'boards' } & BoardFragment>
}
...
>
export type DeleteBoardMutationResult = Apollo.MutationResult<
  DeleteBoardMutation
>
...
>
export type InsertBoardMutationResult = Apollo.MutationResult<
  InsertBoardMutation
>
...
/**
 * __useFeedsSubscription__
 *
 * To run a query within a React component, call `useFeedsSubscription` and pass it any options that fit your needs.
 * When your component renders, `useFeedsSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFeedsSubscription({
 *   variables: {
 *   },
 * });
 */
export function useFeedsSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
    FeedsSubscription,
    FeedsSubscriptionVariables
  >,
) {
  return Apollo.useSubscription<FeedsSubscription, FeedsSubscriptionVariables>(
    FeedsDocument,
    baseOptions,
  )
}
export type FeedsSubscriptionHookResult = ReturnType<
  typeof useFeedsSubscription
>
export type FeedsSubscriptionResult = Apollo.SubscriptionResult<
  FeedsSubscription
>
